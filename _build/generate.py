...
import data_core, data_data_cloud, data_security, data_messaging, data_web, data_apps

OUT = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))

# Ordered registry of every project (mirrors spring.io/projects active list).
PROJECTS = []
for mod in (data_core, data_data_cloud, data_security, data_messaging, data_web, data_apps):
